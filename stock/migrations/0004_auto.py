...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field technos on 'Player'
        db.create_table(u'stock_player_technos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('player', models.ForeignKey(orm[u'stock.player'], null=False)),
            ('techno', models.ForeignKey(orm[u'stock.techno'], null=False))
        ))
        db.create_unique(u'stock_player_technos', ['player_id', 'techno_id'])


    def backwards(self, orm):
        # Removing M2M table for field technos on 'Player'
        db.delete_table('stock_player_technos')
    ...
    models = {
        ...
        u'stock.player': {
            ...
            'technos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'possessed'", 'symmetrical': 'False', 'to': u"orm['stock.Techno']"})
        },
        u'stock.system': {
