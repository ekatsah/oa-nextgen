...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TechnoFeature.int_value'
        db.alter_column(u'stock_technofeature', 'int_value', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TechnoFeature.int_value'
        db.alter_column(u'stock_technofeature', 'int_value', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'stock.technofeature': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'int_value': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
