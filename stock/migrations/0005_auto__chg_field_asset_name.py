...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'stock_asset', 'name', self.gf('django.db.models.fields.CharField')(max_length='40'))

    def backwards(self, orm):

        # Changing field 'Asset.name'
        db.alter_column(u'stock_asset', 'name', self.gf('django.db.models.fields.CharField')(max_length='50'))
